...
// 播放箭头裁剪器
class PlayArrowClipper extends CustomClipper<Path> {
  final double triangleSize;
  final double cornerRadius;

  PlayArrowClipper({this.triangleSize = 16.0, this.cornerRadius = 2.0});
  ...
  // 添加圆角连接的辅助方法（与 PlayArrowPainter 中的相同）
  void _addRoundedConnection(
    Path path,
    Offset from,
    Offset to,
  ...
  bool shouldReclip(covariant CustomClipper<Path> oldClipper) {
    return oldClipper is PlayArrowClipper &&
        (oldClipper.triangleSize != triangleSize ||
